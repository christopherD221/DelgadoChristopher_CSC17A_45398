...
void filBoat(int [], const int, ComBoard &);                         //Fills computers boats with random values 
void usrBoat(int [], const int, ComBoard &);                         //Fills player choice for boats
void dsplyBd(int[], const int, ComBoard &, UsrBoard &, int[]);       //Displays user and computer board
void hitMiss(ComBoard &, int [], const int, int);                    //Function that figures out if player got a hit or a miss
void cmpChce(UsrBoard &, int [], const int);                         //Function that figures out if computer got a hit or a miss
bool winLose(int [], int[], ComBoard &, bool, bool &);               //Determines whether or not the game has been won or lost
void hiScore(ofstream &, ifstream &, ComBoard &);                    //Opens high score file and checks if you have high score
void statFle(Stats &, ofstream &, ifstream &, ComBoard &);           //Puts Stats structure into a binary file
...
int main(int argc, char** argv) {
    ...
    ComBoard cBoard(gmeStat.name, size);
...
void dsplyBd(int boat[], const int NBOATS, ComBoard &g, UsrBoard &u, int boats[]){
...
void filBoat(int a[], const int NBOATS, ComBoard &g){
...
void usrBoat(int a[], const int NBOATS, ComBoard &g){
...
void hitMiss(ComBoard &g, int boats[], const int NBOATS, int choice){
...
bool winLose(int boats[], int pBoats[], ComBoard &g, bool loop, bool &win){
...
void hiScore(ofstream &oFile, ifstream &iFile, ComBoard &g){
...
void statFle(Stats & game, ofstream &oFile, ifstream &iFile, ComBoard &g){
